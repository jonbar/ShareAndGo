<div class="tarjetaViaje">
    ...
    <div id="nombreConductor" >
        <nombreConductor class="nombreExperiencia">
            <nombre class="nombre">Jon Barrutieta</nombre>
    ...
    <div id="informacion" class="informacion">
        <div id="tipo_trayecto" class="tipoTrayecto">
            <tipoViaje class="tipoSeleccionado">ocasional</tipoviaje>
            <tipoViaje class="tipoSeleccionado">frecuente</tipoviaje>
        </div>
        <table class="dias">
            <tr>
                <td><div class="dia">L</div></td>
                <td><div class="dia">M</div></td>
                <td><div class="dia">X</div></td>
                <td><div class="dia">J</div></td>
                <td><div class="dia">V</div></td>
            </tr>   
        </table>
    </div>
    <div id="informacion" class="informacion">
        <div id="plazas_disponibles" class="zonaPlazas">
            Numero de plazas: <numero id="numeroPlazas" class="plazas">5</numero>
        </div>
    </div>
